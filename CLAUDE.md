...
- **After any refactor**: run `docker build -t pa-assistant . -q && docker run --rm --env-file .env pa-assistant python -c "from main import _build_agent"` to verify the app can start. Unit tests are NOT sufficient — they mock too much.
