    ...
    return [
        ScheduledJob(
            ...
            prompt=(
                ...
                "**News** — use web_search to find 3-5 noteworthy headlines from overnight. "
                "Focus on: world events, geopolitics, AI/tech, Portugal, markets. "
                "One line per item, no fluff. Skip if nothing significant.\n\n"
