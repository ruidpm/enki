...
@pytest.mark.asyncio
async def test_report_all_teams_formats_table(
    tool: TeamReportTool, store: TeamsStore
) -> None:
...
@pytest.mark.asyncio
async def test_report_specific_team(
    tool: TeamReportTool, store: TeamsStore
) -> None:
...
@pytest.mark.asyncio
async def test_report_success_rate_shown(
    tool: TeamReportTool, store: TeamsStore
) -> None:
